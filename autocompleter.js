Vue.component('v-autocompleter', {
    ...
    props: ['value', 'options'],
    /**
     * dzięki "value" przekazujemy naszą frazę, zaś "options" to nasza tworzona lista
     */
    data: function(){
        return {
            selected_city: '',
    ...
    watch: {
      /**
       * dzięki tej funkcji możemy przechodzić po liście
       */
        forPick: function () {
            this.updated = false;
    ...
    methods: {
      /**
       * funkcja, która pokazuje nam 10 miast, które zawierają wpisaną frazę
       */
      CreateCities(){
    ...
    /**
     * Wystawienie eventu, po kliknięciu
     * @param {miasto} name 
     */
      handleClick(name) {
      ...
      /**
       * Wystawienie eventu po wybraniu miasta o indeksie "i" z listy
       * @param {indeks} i 
       */
      choose(i){
    ...
    /**
     * pogrubienie tekstu, który nie został wpisany
     * @param {fraza} phrase 
     * @returns 
     */
      ...
      /**
       * funkacja obsługuje przechodzenie w dół po liście
       */
      goDown(){
        ...
        /**
         * przechodzenie w górę po liście
         */
      goUp(){
       if(this.forPick > -1){
           this.forPick -= 1;
      ...
      /**
       * Po naciśnięciu enter, wystawiany jest event po wybraniu miasta z listy
       * @param {event} event 
       */
